...
int main() {
    ...
    /* Here in this code, we take the first node as a dummy node.
      The first node does not contain data, but it used because to avoid handling special casesin insert and delete functions.
    */
    printf("1. Insert\n");
    printf("2. Delete\n");
    printf("3. Print\n");
    printf("4. Find\n");
    printf("Manage integer only. And insert to the last node\n");
    while(1)
    {
        int query;
        scanf("%d",&query);
